package com.tahadroid.wing.ui.fragments.home.shops.adapters
...
class RecommendedShopAdapter(val listener: (View, Shop, Int) -> Unit) :
    RecyclerView.Adapter<RecommendedShopAdapter.ProductViewHolder>() {
